...
TMDB_API_KEY = os.getenv("TMDB_API_KEY", "f5cfc814c0803e99b75ef4968f87679e")
...
async def rename_episode(client: Client, message: Message):
    ...
    TMDB_API_KEY = "f5cfc814c0803e99b75ef4968f87679e"  # Replace with your real key
...
TMDB_API_KEY = "f5cfc814c0803e99b75ef4968f87679e"
...
TMDB_API_KEY = os.environ.get("TMDB_API_KEY", "f5cfc814c0803e99b75ef4968f87679e")
